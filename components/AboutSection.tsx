      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-x-[80px] gap-y-[60px] w-full">
        ...
        >
          ...
          <a
            ...
            className="group/btn flex items-center gap-[7px] rounded-full h-8 px-[13px] py-2 w-fit mt-2 transition-all duration-300 backdrop-blur-md bg-[rgba(255,255,255,0.55)] border border-[rgba(0,0,0,0.08)] shadow-[inset_1px_1.5px_1.5px_rgba(255,255,255,0.85),inset_-1px_-1px_1px_rgba(0,0,0,0.08),0px_4px_16px_rgba(0,0,0,0.08)] hover:bg-[rgba(255,255,255,0.75)] hover:shadow-[inset_1px_1.5px_1.5px_rgba(255,255,255,0.9),inset_-1px_-1px_1px_rgba(0,0,0,0.06),0px_6px_20px_rgba(0,0,0,0.1)]"
          >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-[10px]">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="border border-[rgba(0,0,0,0.08)] rounded-full px-[15px] py-[7px] font-inter font-normal text-[11px] text-[#666] leading-[15.4px]"
                >
                  {skill}
                </span>
              ))}
